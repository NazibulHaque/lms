...
<div id="app" class="<?php echo e((!empty($floatingBar) and $floatingBar->position == 'top' and $floatingBar->fixed) ? 'has-fixed-top-floating-bar' : ''); ?>" style="background: #03060F">
...
<?php /**PATH D:\Matjar-online\lms\resources\views/web/default/layouts/app.blade.php ENDPATH**/ ?>