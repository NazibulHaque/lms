...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(!empty($heroSectionData)): ?>
      ...
      <section class="slider-container <?php echo e($heroSection == '2' ? 'slider-hero-section2' : ''); ?>"
        style="
            background-image: url('<?php echo e(asset('assets/admin/img/BackgroundVectors.png')); ?>');
        ...
        <?php if($homeSection->name == \App\Models\HomeSection::$reward_program and !empty($rewardProgramSection)): ?>
            <section class="home-sections home-sections-swiper container reward-program-section position-relative">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                        <div class="">
                            <h2 class="font-36 font-weight-bold text-white"><?php echo e($rewardProgramSection['title'] ?? ''); ?></h2>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Matjar-online\lms\resources\views/web/default/pages/home.blade.php ENDPATH**/ ?>